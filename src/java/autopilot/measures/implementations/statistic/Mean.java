...
/**
 * Focus measure based on the mean of the pixel intensities.
 * 
 * @author royer
 */
public class Mean extends DownScalingFocusMeasure	implements
																									FocusMeasureInterface
{
	...
	/**
	 * Computes the focus measure based on the mean of the pixel intensities.
	 * 
